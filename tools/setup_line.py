...
GREETING = (
    ...
    "ReLoop — ระบบช่วยเกือกเกษตรกร by ดร.ตวงพร & ดร.ดารารัตน์ มช.\n\n"
    "✅ ถามได้เลย (พิมพ์ภาษาไทย)\n"
    "• โรคพืช ใบเหลือง เชื้อรา แมลงศัตรู\n"
    "• ดิน ปุ๋ย การเก็บเกี่ยว\n"
    "• สิทธิประโยชน์รัฐบาล\n\n"
    "📷 ส่งรูปพืชที่มีปัญหา AI วิเคราะห์ให้ครับ\n\n"
    "📋 กดเมนูด้านล่าง หรือพิมพ์ 'วิธีใช้'\n\n"
    "⚠️ คำตอบอ้างอิงจากผู้เชี่ยวชาญ คำถามความเสี่ยงส่งต่อทันที"
)
